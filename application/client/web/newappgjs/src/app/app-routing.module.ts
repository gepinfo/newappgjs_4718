...
{ path : 'updatetest', loadChildren: () => import('./updatetest/updatetest.module').then(m => m.UpdatetestModule), canActivate: [AuthGuard] } , 
{ path : 'searchupdatetest', loadChildren: () => import('./searchupdatetest/searchupdatetest.module').then(m => m.SearchupdatetestModule), canActivate: [AuthGuard] } , 
];
